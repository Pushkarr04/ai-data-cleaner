...
from modules.quality import show_quality_analysis

st.set_page_config(page_title="Data Overview | DataCleaner AI", page_icon="🔍", layout="wide")
...
if st.session_state.get('raw_df') is not None:
    show_quality_analysis(st.session_state['raw_df'])
else:
    st.markdown("""
